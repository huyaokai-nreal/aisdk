...
// enum class aisdk::xengine::ElementType : int32_t {
//     UNKNOWN = 0,
//     FLOAT32 = 1,
//     FLOAT16 = 2,
//     UINT8 = 3,
...
// enum class aisdk::xengine::TensorFormat : int32_t {
//     UNKNOWN = 0,
//     NCHW = 1,
//     NHWC = 2,
//     CHW = 3,
...
struct WrapTrtTensor {
    ...
    int32_t dimtype = 0;     // aisdk::xengine::TensorFormat 
    int32_t elementype = 0;  // aisdk::xengine::ElementType 
