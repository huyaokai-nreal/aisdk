...
bool HandFilters::init() {
    ...
    if (glasses_type_ == "flora") {
        ...
        palm_params.beta = {30.0, 30.0, 30.0};    // 运动状态下alpha的变化速率，alpha越大，跟踪越及时
        palm_params.dcutoff = {1.8, 1.8, 0.8};    // 速度滤波的固定效果

        // 手指
        finger_params.mincutoff = {0.15, 0.15, 0.1};
        finger_params.beta = {25.0, 25.0, 25.0};
        finger_params.dcutoff = {1.8, 1.9, 0.8};
