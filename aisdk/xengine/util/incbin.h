...
#define INCBIN_EXTERN_MY(...) INCBIN_CONCATENATE(INCBIN_EXTERN_MY_, INCBIN_VA_ARGC(__VA_ARGS__))(__VA_ARGS__)
#define INCBIN_EXTERN_MY_1(NAME, ...) INCBIN_EXTERN_MY_2(NAME, ##__VA_ARGS__)
#define INCBIN_EXTERN_MY_2(NAME, AES)                                                                      \
    {                                                                                                      \
#NAME, AES, INCBIN_CONCATENATE(INCBIN_CONCATENATE(INCBIN_PREFIX, NAME), INCBIN_STYLE_IDENT(DATA)), \
            INCBIN_CONCATENATE(INCBIN_CONCATENATE(INCBIN_PREFIX, NAME), INCBIN_STYLE_IDENT(END)),          \
            INCBIN_CONCATENATE(INCBIN_CONCATENATE(INCBIN_PREFIX, NAME), INCBIN_STYLE_IDENT(SIZE))          \
    }
