 ...
 */
static inline void lmdb::env_open(MDB_env* const env, const char* const path, const unsigned int flags,
                                  const mode mode) {
 ...
 */
static inline void lmdb::env_set_flags(MDB_env* const env, const unsigned int flags, const bool onoff = true) {
 ...
 */
static inline void* lmdb::env_get_userctx(MDB_env* const env) { return ::mdb_env_get_userctx(env); }
#endif
 ...
 */
static inline void lmdb::txn_begin(MDB_env* const env, MDB_txn* const parent, const unsigned int flags, MDB_txn** txn) {
 ...
 */
static inline std::size_t lmdb::txn_id(MDB_txn* const txn) noexcept { return ::mdb_txn_id(txn); }
#endif
 ...
 */
static inline void lmdb::dbi_open(MDB_txn* const txn, const char* const name, const unsigned int flags,
                                  MDB_dbi* const dbi) {
 ...
 */
static inline void lmdb::dbi_flags(MDB_txn* const txn, const MDB_dbi dbi, unsigned int* const flags) {
 ...
 */
static inline void lmdb::dbi_close(MDB_env* const env, const MDB_dbi dbi) noexcept { ::mdb_dbi_close(env, dbi); }
 ...
 */
static inline void lmdb::dbi_set_compare(MDB_txn* const txn, const MDB_dbi dbi, MDB_cmp_func* const cmp = nullptr) {
 ...
 */
static inline void lmdb::dbi_set_dupsort(MDB_txn* const txn, const MDB_dbi dbi, MDB_cmp_func* const cmp = nullptr) {
 ...
 */
static inline void lmdb::dbi_set_relfunc(MDB_txn* const txn, const MDB_dbi dbi, MDB_rel_func* const rel) {
 ...
 */
static inline bool lmdb::dbi_get(MDB_txn* const txn, const MDB_dbi dbi, const MDB_val* const key, MDB_val* const data) {
 ...
 */
static inline bool lmdb::dbi_put(MDB_txn* const txn, const MDB_dbi dbi, const MDB_val* const key, MDB_val* const data,
 ...
 */
static inline bool lmdb::dbi_del(MDB_txn* const txn, const MDB_dbi dbi, const MDB_val* const key,
 ...
 */
static inline void lmdb::cursor_open(MDB_txn* const txn, const MDB_dbi dbi, MDB_cursor** const cursor) {
 ...
 */
static inline void lmdb::cursor_close(MDB_cursor* const cursor) noexcept { ::mdb_cursor_close(cursor); }
 ...
 */
static inline MDB_txn* lmdb::cursor_txn(MDB_cursor* const cursor) noexcept { return ::mdb_cursor_txn(cursor); }

/**
 * @see http://symas.com/mdb/doc/group__mdb.html#ga2f7092cf70ee816fb3d2c3267a732372
 */
static inline MDB_dbi lmdb::cursor_dbi(MDB_cursor* const cursor) noexcept { return ::mdb_cursor_dbi(cursor); }

/**
 * @throws lmdb::error on failure
 * @see http://symas.com/mdb/doc/group__mdb.html#ga48df35fb102536b32dfbb801a47b4cb0
 */
static inline bool lmdb::cursor_get(MDB_cursor* const cursor, MDB_val* const key, MDB_val* const data,
 ...
 */
static inline void lmdb::cursor_put(MDB_cursor* const cursor, MDB_val* const key, MDB_val* const data,
                                    const unsigned int flags = 0) {
...
class lmdb::val {
   ...
   public:
     ...
     * Constructor.
     */
    val(const void* const data, const std::size_t size) noexcept : _val{size, const_cast<void*>(data)} {}
...
class lmdb::dbi {
   ...
   public:
     ...
     * @throws lmdb::error on failure
     */
    void drop(MDB_txn* const txn, const bool del = false) { lmdb::dbi_drop(txn, handle(), del); }
     ...
     * @throws lmdb::error on failure
     */
    bool get(MDB_txn* const txn, const val& key, val& data) { return lmdb::dbi_get(txn, handle(), key, data); }
